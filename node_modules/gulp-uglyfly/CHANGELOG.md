# gulp-uglyfly changelog

## 1.4.1
- Updated to use uglyfly-js v. 3.2.1 (major fixes included)

## 1.2.0
- Added parallelization support

## 1.1.0
- Forked from gulp-uglify
- Switched uglify-js dependency (UglifyJS2) to the asynchronous uglyfly-js library (UglyflyJS)
- Revised parts of tests to run in async callbacks
- Added implicit workaround for streams (insted of throwing errors)
